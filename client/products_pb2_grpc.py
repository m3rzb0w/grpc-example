...
class ProductsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.CheckProductsAvailability = channel.unary_unary(
                '/products.ProductsService/CheckProductsAvailability',
...
class ProductsServiceServicer(object):
    ...
    def CheckProductsAvailability(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_ProductsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CheckProductsAvailability': grpc.unary_unary_rpc_method_handler(
                    servicer.CheckProductsAvailability,
...
class ProductsService(object):
    ...
    @staticmethod
    def CheckProductsAvailability(request,
            target,
            options=(),
